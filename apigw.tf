...
resource "aws_lambda_permission" "apigw_lambda" {
  ...
  source_arn = "arn:aws:execute-api:eu-west-2:${data.aws_caller_identity.current.account_id}:${aws_api_gateway_rest_api.crop_tool_api.id}/*/${aws_api_gateway_method.image_method.http_method}${aws_api_gateway_resource.image_resource.path}"
}
